...
<div id="listValues">
	...
	<input placeholder="Форма светильн" list="di" id="diff" on:blur={checkList}/>
	<datalist id="di">
	...
	<input placeholder="цоколь" list="ty" id="type" on:blur={checkList}/>
	<datalist id="ty">
	...
	<input id="watt" placeholder="Мощность(Вт)" on:input={checkInt} type="number"/>
	<input id="qtysock" placeholder="Кол-во ламп" on:input={checkInt} type="number"/>
