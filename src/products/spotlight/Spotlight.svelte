...
<div>
   <span class="span1">Назначение</span>
   <span class="span2">{name.link.data.attributes.link.function[name.function]}</span>
</div>

<div>
   <span class="span1">Тип цоколя</span>
   <span class="span2">{name.lampholder}</span>
</div>
