...
<div id="listValues">
    ...
    <input placeholder="Электронный" list="me" id="mechtype" on:blur={checkList}/>
	<datalist id="me">
	...
	<input id="wirethickmin" placeholder="Мин.изм(мм)" on:blur={around} type="number" step="0.01" min="0"/>
	<input id="wirethickmax" placeholder="Макс.изм(метр)" on:blur={around} type="number" step="0.01" min="0"/>
